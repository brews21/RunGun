////
// Can use this to enable multy maps
//#include <vector>
//#include "MapLoader.h"
//#include "base64.h"
//#include "zlib.h"
...
//    
//    
//    TextureManager::Singleton()->load(pTilesetRoot->FirstChildElement()->Attribute("source"), pTilesetRoot->Attribute("name"), Game::Singleton()->getRenderer());
//    
