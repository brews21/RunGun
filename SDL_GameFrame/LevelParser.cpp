...
void LevelParser::parseTextures(TiXmlElement* pTextureRoot)
{
    ...
    TextureManager::Singleton()->load(pTextureRoot->Attribute("value"), pTextureRoot->Attribute("name"), Game::Singleton()->getRenderer());
}
...
void LevelParser::parseTilesets(TiXmlElement* pTilesetRoot, std::vector<Tileset>* pTilesets)
{
    ...
    TextureManager::Singleton()->load(assetsTag.append(pTilesetRoot->FirstChildElement()->Attribute("source")), pTilesetRoot->Attribute("name"), Game::Singleton()->getRenderer());
...
void LevelParser::parseObjectLayer(TiXmlElement* pObjectElement, std::vector<Layer*> *pLayers, Level* pLevel)
{
    ...
    for(TiXmlElement* e = pObjectElement->FirstChildElement(); e != NULL; e = e->NextSiblingElement())
    {
        if(e->Value() == std::string("object"))
        {
			...
			GameObject* pGameObject = GameObjectFactory::Singleton()->create(type);
