...
BulletHandler* BulletHandler::s_pSingleton = new BulletHandler();
...
void BulletHandler::updateBullets()
{
    ...
    {
        if((*p_it)->getPosition().getX() < 0 || (*p_it)->getPosition().getX() > Game::Singleton()->getGameWidth()
           || (*p_it)->getPosition().getY() < 0 || (*p_it)->getPosition().getY() > Game::Singleton()->getGameHeight() || (*p_it)->dead())
        {
            delete *p_it;
    ...
    {
        if((*e_it)->getPosition().getX() < 0 || (*e_it)->getPosition().getX() > Game::Singleton()->getGameWidth()
           || (*e_it)->getPosition().getY() < 0 || (*e_it)->getPosition().getY() > Game::Singleton()->getGameHeight() || (*e_it)->dead())
        {
            delete *e_it;
