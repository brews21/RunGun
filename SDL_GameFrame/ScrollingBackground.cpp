...
{
    // draw first rect
    SDL_RenderCopyEx(Game::Singleton()->getRenderer(), TextureManager::Singleton()->getTextureMap()[m_textureID], &m_srcRect1, &m_destRect1, 0, 0, SDL_FLIP_NONE);
    
    // draw second rect
    //SDL_RenderCopyEx(Game::Singleton()->getRenderer(), TextureManager::Singleton()->getTextureMap()[m_textureID], &m_srcRect2, &m_destRect2, 0, 0, SDL_FLIP_NONE);
}
